...
![ArabicBERT medium confusion matrix](images/ArabicBERT medium confusion matrix.PNG)

![Weighted Soft voting confusion matrix](images/Weighted Soft voting confusion matrix.png)
